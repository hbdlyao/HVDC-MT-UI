...
namespace cn.csg.dpcp.common
{
    public class Constants
    {
        ...
        /// </summary>
        public const string CxbUIDCLine = "CxbUIDCLine";

        /// <summary>
        /// 直流侧谐波分析与设计 直流侧滤波器设计 单回线 接地极线路参数
        /// </summary>
        public const string CxbUIGroundLine = "CxbUIGroundLine";

        /// <summary>
        /// 直流侧谐波分析与设计 直流侧滤波器设计 单回线 主要网络参数
        /// </summary>
        public const string CxbUIDevParam = "CxbUIDevParam";

        /// <summary>
        /// 直流侧谐波分析与设计 直流侧滤波器设计 单回线 工况选择
        /// </summary>
        public const string CxbUIOrder = "CxbUIOrder";

        /// <summary>
        /// 直流侧谐波分析与设计 直流侧滤波器设计 单回线 结果显示
        /// </summary>
        public const string CxbUIDataFromU3p = "XBDataFromuU3pUI";

        /// <summary>
        /// 直流侧谐波分析与设计 直流侧滤波器设计 三脉动 数据导入
        /// </summary>
        public const string U3p_DataFromuMcUI = "U3pDataFromuMcUI";
        ...
        /// 主回路 参数录入
        /// </summary>
        public const string btnMcParam = "btnMcParam";

        /// <summary>
        /// 主回路 工况
        /// </summary>
        public const string btnMcOrder = "btnMcOrder";

        /// <summary>
        /// 主回路 结果
        /// </summary>
        public const string btnMcResult = "btnMcResult";

        /// <summary>
        /// 直流侧谐波分析与设计 谐波 直流线路参数 参数录入
        /// </summary>
        public const string btnDcLineParamMenu = "btnDcLineParamMenu";
    }
}
