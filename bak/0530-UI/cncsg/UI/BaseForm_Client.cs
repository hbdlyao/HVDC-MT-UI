...
{
    public class BaseForm_Client : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.Name = "BaseForm_Client";
            this.ShowIcon = false;
            this.ShowInTaskbar = false;
            this.Load += new System.EventHandler(this.BaseForm_Client_Load);
        ...
        public BaseForm_Client()
        {
            InitializeComponent();
        }

        public BaseForm_Client(CDevGrid vGrid, int vGridType, int vTblType)
        {
            InitializeComponent();
        ...
        private void BaseForm_Client_Load(object sender, System.EventArgs e)
        {
            //EnableControl();
        }
    }
