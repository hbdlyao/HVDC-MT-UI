...
namespace cn.csg.dpcp.ui
{
    class CPanelHelper
    {
        ...
        public CPanelHelper()
        {
            ...
            uiMap.Add(Constants.C3pXf2UI, new C3pUIXf2());
            uiMap.Add(Constants.C3pConvertorUI, new C3pUIConvertor());
            //uiMap.Add(Constants.C3MdSrcAlgOptionUI, new C3pSrcAlgOptionUI());
            //uiMap.Add(Constants.C3MdSysDiffInUI, new C3pSysDiffInUI());
            uiMap.Add(Constants.C3pAcSysUIcs, new C3pUIAcSys());
            uiMap.Add(Constants.C3pOrderUI, new C3pUIOrder());
            uiMap.Add(Constants.U3p_DataFromuMcUI, new C3pUIDataFromMc());
            #endregion

            #region 阻抗
            uiMap.Add(Constants.CzkTxBaseUI, new CzkUITxBase());
            ...
            uiMap.Add(Constants.CzkOrderUI, new CzkUIOrder());
            #endregion
