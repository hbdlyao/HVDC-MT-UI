...
{
    public class CMCDcLineDAL : BaseDAL<CMCDcLineVo>
    {
        protected override CMCDcLineVo FillVo4Batch(OleDbDataReader reader)
        {
            CMCDcLineVo vo = new CMCDcLineVo();
            Fill(vo, reader);
            return vo;
        }

        protected override void Fill(CMCDcLineVo vo, OleDbDataReader reader)
        {
            vo.ID = (int)reader["ID"];
        ...
        protected override int Addnew(CMCDcLineVo vo, string tableName)
        {
            int id = -1;
        ...
        protected override int Update(CMCDcLineVo vo, string tableName)
        {
            //CMCAcSystemVo vo = baseVo as CMCAcSystemVo;
